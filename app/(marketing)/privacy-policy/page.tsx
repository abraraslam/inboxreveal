    ...
    <>
      ...
      <main className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-slate-50 px-4 py-14 sm:px-6 sm:py-20">
        <section className="mx-auto max-w-4xl rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-10">
          <h1 className="text-3xl font-bold text-slate-900 sm:text-4xl text-center">Privacy Policy</h1>
          ...
          <div className="mt-8 space-y-6 text-slate-700 text-center">
            <section>
              <h2 className="text-xl font-semibold text-slate-900 text-center">Overview</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-slate-900 text-center">Data We Process</h2>
              <p className="mt-2 text-center">
            ...
            <section>
              <h2 className="text-xl font-semibold text-slate-900 text-center">How We Use Data</h2>
              <p className="mt-2 text-center">
            ...
            <section>
              <h2 className="text-xl font-semibold text-slate-900 text-center">Your Choices</h2>
              <p className="mt-2 text-center">
