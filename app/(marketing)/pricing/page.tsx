...
const plans: PricingPlan[] = [
  {
    ...
    period: "forever",
    description:
      "Perfect for individuals who want clear inbox priorities without extra complexity.",
    icon: Star,
  ...
  },
  {
    ...
    period: "per month",
    description:
      "For professionals who want AI summaries, smarter reply drafting, and more control over busy inboxes.",
    icon: Sparkles,
  ...
  },
  {
    ...
    period: "per month",
    description:
      "For advanced users who want the full AI workflow, including Gold-only draft review tools.",
    icon: Crown,
            ...
            {plans.map((plan) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className={`mb-5 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br ${plan.accent}`}
                  >
                  ...
                  <Link
                    ...
                    className={`mt-8 inline-flex w-full items-center justify-center rounded-lg bg-gradient-to-r px-4 py-2.5 text-sm font-semibold text-white shadow-md transition hover:shadow-lg ${plan.accent}`}
                  >
                    {plan.cta}
                  </Link>
                </article>
