        ...
        <div className="relative w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl sm:p-8">
          ...
          <div className="space-y-3">
            ...
            >
              ...
              {signingProvider === "google" ? "Redirecting..." : "Sign in with Google (Gmail)"}
            </button>
            <button
              onClick={() => handleProviderSignIn("azure-ad")}
              disabled={signingProvider !== null}
              className="inline-flex w-full items-center justify-center gap-3 rounded-lg border border-blue-300 bg-blue-50 px-4 py-3 font-semibold text-blue-700 shadow-sm transition hover:bg-blue-100"
            >
              <svg className="h-5 w-5" viewBox="0 0 24 24" aria-hidden="true">
              ...
              {signingProvider === "azure-ad" ? "Redirecting..." : "Sign in with Microsoft (Outlook)"}
            </button>
          </div>
        </div>
      </div>
